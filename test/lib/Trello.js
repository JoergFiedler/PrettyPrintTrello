(function () {
  var opts = {"version": 1, "apiEndpoint": "https://api.trello.com", "authEndpoint": "https://trello.com", "key": ""};
  (function () {
    ...
    w = function (c, g) {
      ...
      if (h[c]) {
        f = h[c];
        delete h[c];
        for (d = 0, z = f.length; d < z; d++)a = f[d], a(g)
      }
    };
    v = function (c) {
    ...
    (function (c, g, a) {
      ...
      f = {version: function () {
        ...
        b = /[&#]?token=([0-9a-f]{64})/;
        f = function () {
          if (a.persist && null != e)return q("token", e)
        };
        a.persist && null == e && (e = t("token"));
        null == e && (e = null != (i = b.exec(l.hash)) ? i[1] : void 0);
        if (this.authorized())return f(), l.hash = l.hash.replace(b, ""), "function" === typeof a.success ? a.success() : void 0;
        if (!a.interactive)return"function" === typeof a.error ? a.error() : void 0;
        n = function () {
          var b, c;
          b = a.scope;
          c = [];
          for (d in b)(h = b[d]) && c.push(d);
          return c
        }().join(",");
        switch (a.type) {
          case "popup":
